...
#include "husky_panda_manipulation/reference_scheduler.h"
...
class PandaControllerInterface : public husky_panda_ros::ControllerRos {
 public:
  ...
  void update_reference(const husky_panda_control::observation_t& x, const double t);

  mppi_pinocchio::Pose get_pose_handle(const husky_panda_control::observation_t& x);
  mppi_pinocchio::Pose get_pose_end_effector(const husky_panda_control::observation_t& x);

  geometry_msgs::PoseStamped get_pose_handle_ros(const husky_panda_control::observation_t& x);
  ...
  double get_stage_cost(const husky_panda_control::observation_t& x, const husky_panda_control::input_t& u,
                        const double t);
  bool init_reference_to_current_pose(const husky_panda_control::observation_t& x,
                                      const double t);
 ...
 private:
  bool reference_set_;
  std::unique_ptr<husky_panda_control::PandaCost> local_cost_;
