...
bool PandaControllerInterface::set_controller(husky_panda_control::solver_ptr& controller) {
  // -------------------------------
  // internal model
  // -------------------------------
  ...
  // dynamics
  // -------------------------------
  husky_panda_control::dynamics_ptr dynamics;
  ...
  local_cost_ = std::make_unique<husky_panda_control::PandaCost>(cost_params);
  ...
  // -------------------------------
  ref_.rr.resize(1, husky_panda_control::observation_t::Zero(PandaDim::REFERENCE_DIMENSION));
...
bool PandaControllerInterface::init_reference_to_current_pose(
    const husky_panda_control::observation_t& x, const double t) {
...
double PandaControllerInterface::get_stage_cost(const husky_panda_control::observation_t& x,
...
void PandaControllerInterface::update_reference(const husky_panda_control::observation_t& x,
                                                const double t) {
