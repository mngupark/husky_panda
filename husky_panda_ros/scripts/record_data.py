...
import pandas as pd
import numpy as np
from husky_panda_ros.msg import Data
...
class DataRecorder:
    def __init__(self, experiment_id="exp"):
        ...
        self.data_subscriber = rospy.Subscriber("/husky_panda_control_data",
                                                Data,
                                                self.data_callback,
                                                queue_size=10)
        ...
        self.csv_file = os.path.join(RosPack().get_path("husky_panda_ros"), "log",
                                     "record.csv")
