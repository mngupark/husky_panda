...
void to_msg(const husky_panda_control::Rollout& rollout, Rollout& rollout_ros, const bool input_only, const size_t max_length) {
  ...
  husky_panda_ros::Array state, input, noise;
...
void to_msg(const husky_panda_control::data_t& data, Data& data_ros) {
  ...
  //  husky_panda_ros::Rollout rollout_ros;
