#include <cmath>
#include <husky_panda_controller/husky_panda_controller.h>
...
namespace husky_panda_controller{
  ...
  HuskyPandaController::HuskyPandaController()
    : open_loop_(false)
    , command_struct_()
  ...
  void HuskyPandaController::starting(const ros::Time& time)
  {
    brake();
  ...
  void HuskyPandaController::stopping(const ros::Time& /*time*/)
  {
    brake();
  }

  void HuskyPandaController::brake()
  {
  ...
  void HuskyPandaController::cmdVelCallback(const geometry_msgs::Twist& command)
  {
    if (isRunning())
    {
  ...
  bool HuskyPandaController::getWheelNames(ros::NodeHandle& controller_nh,
  ...
  bool HuskyPandaController::setOdomParamsFromUrdf(ros::NodeHandle& root_nh,
  ...
  void HuskyPandaController::setOdomPubFields(ros::NodeHandle& root_nh, ros::NodeHandle& controller_nh)
  {
  ...
  void HuskyPandaController::reconfCallback(HuskyPandaControllerConfig& config, uint32_t /*level*/)
  {
    DynamicParams dynamic_params;
  ...
  void HuskyPandaController::updateDynamicParams()
  {
  ...
  void HuskyPandaController::publishWheelData(const ros::Time& time, const ros::Duration& period, Commands& curr_cmd,
...
PLUGINLIB_EXPORT_CLASS(husky_panda_controller::HuskyPandaController, controller_interface::ControllerBase);