...
PYBIND11_MODULE(pyhusky_panda_control, m) {
  ...
  py::class_<husky_panda_control::RecedingHorizonSpline>(m, "RecedingHorizonSpline")
  ...
  py::class_<husky_panda_control::Config>(m, "Config")
      .def(py::init<>())
  ...
  py::class_<husky_panda_control::GaussianPolicy>(m, "GaussianPolicy")
      .def(py::init<int, const husky_panda_control::Config&>())
  ...
  py::class_<husky_panda_control::SplinePolicy>(m, "SplinePolicy")
      .def(py::init<int, const husky_panda_control::Config&>())
