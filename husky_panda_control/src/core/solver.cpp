/*!
 * @file     husky_panda_control_new.cpp
...
#include "husky_panda_control/utils/logging.h"
#include "husky_panda_control/utils/savgol_filter.h"
...
void Solver::set_reference_trajectory(husky_panda_control::reference_trajectory_t& ref) {
