...
#include <memory>
#include <Eigen/Core>
#include "husky_panda_control/utils/multivariate_normal_eigen.h"

namespace husky_panda_control { struct control_points; }

std::ostream &operator<<(std::ostream &os, const husky_panda_control::control_points &cp);
