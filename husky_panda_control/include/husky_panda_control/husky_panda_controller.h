...
#include <husky_panda_control/HuskyPandaControllerConfig.h>

// Custom headers
#include <husky_panda_control/odometry.h>
#include <husky_panda_control/speed_limiter.h>
...
namespace husky_panda_control{
  ...
  private:
    ...
    typedef dynamic_reconfigure::Server<HuskyPandaControllerConfig> ReconfigureServer;
  ...
  private:
     ...
     */
    void reconfCallback(HuskyPandaControllerConfig& config, uint32_t /*level*/);
